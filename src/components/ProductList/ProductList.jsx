...
const ProductList = () => {
    ...
    const onSendData = useCallback(async () => {
        ...
        try {
            ...
            if (mx?.showAlert) {
                ...
                alert('Заказ успешно оформлен!'); // Fallback для браузера
            }
            
            // В Max закрытие приложения делается через mx.close()
    ...
    return (
        <div className="list">
            ...
            {/* Собственная нижняя кнопка, заменяющая MainButton */}
            {!isCartEmpty && (
